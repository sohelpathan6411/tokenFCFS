All the module are built in flutter with firebase and firestore, role based login based on mobile number is detected (we will need to use firebase admin in Web console in future)
